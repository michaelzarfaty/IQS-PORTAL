    ...
    <div className="flex min-h-screen bg-background font-sans">
      ...
      <aside className="w-64 bg-[hsl(var(--sidebar-bg))] text-[hsl(var(--sidebar-fg))] flex flex-col h-screen sticky top-0 border-r border-white/10">
        ...
        <div className="flex-1 overflow-y-auto px-3 py-2 scrollbar-none">
          ...
          <SidebarGroup title="NETWORK" allowedRoles={['Admin', 'Client', 'Qualifier']}>
            <SidebarItem 
              icon={<ClipboardList className="w-4 h-4" />} 
              label="Onboarding" 
              href="/onboarding" 
              isActive={location.pathname === "/onboarding"}
              allowedRoles={['Admin', 'Client', 'Qualifier']}
            />
            <SidebarItem 
          ...
          <SidebarGroup title="COMPLIANCE & REPORTS" allowedRoles={['Admin', 'Client']}>
            <SidebarItem 
          ...
          <SidebarGroup title="MONEY" allowedRoles={['Admin', 'Client']}>
            <SidebarItem 
          ...
          <SidebarGroup title="RETENTION" allowedRoles={['Admin']}>
            <SidebarItem 
              icon={<ShieldCheck className="w-4 h-4" />} 
          ...
          <SidebarGroup title="PEOPLE" allowedRoles={['Admin']}>
            <SidebarItem 
              icon={<Users className="w-4 h-4" />} 
              label="Clients CRM" 
        ...
        <div className="p-4 border-t border-white/10 space-y-4">
          ...
          <Link to="/login" className="flex items-center gap-2 text-sm text-[hsl(var(--sidebar-fg))] hover:text-red-400 transition-colors w-full pt-2">
